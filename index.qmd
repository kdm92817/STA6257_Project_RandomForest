...
risk of overfitting by combining multiple decision trees to obtain a
single result.
...
The aggregation method varies depending on the task at hand. For
classification, the final prediction is typically made by taking the
